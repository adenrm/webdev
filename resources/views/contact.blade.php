...
<div class="min-h-full">
    <nav class="bg-cyan-700" x-data="{ isOpen: false }">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-cyan-600 hover:text-white" aria-current="page">Home</a>
                <a href="/about" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-cyan-600 hover:text-white">About</a>
                <a href="/contact" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Contact</a>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
      ...
      <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-cyan-600 hover:text-white" -->
          <a href="/" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-cyan-600 hover:text-white" aria-current="page">Dashboard</a>
          ...
          <a href="/contact" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Contact</a>
        </div>
        ...
        <div class="bg-white py-24 sm:py-32">
          ...
          <h2 class="ml-3 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Hubungi Saya yaaa</h2>
              <ol>
                ...
                <li><a href="https://x.com/dznrap" target="_blank">X</a></li>
              </ol>
            </div>
          </div>
        </div>
